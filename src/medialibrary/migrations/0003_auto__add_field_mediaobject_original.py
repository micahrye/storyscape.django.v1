...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaObject.original'
        db.add_column('medialibrary_mediaobject', 'original',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaObject.original'
        db.delete_column('medialibrary_mediaobject', 'original')
