...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MediaObject.mo_tags'
        db.add_column('medialibrary_mediaobject', 'mo_tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MediaObject.mo_tags'
        db.delete_column('medialibrary_mediaobject', 'mo_tags')
