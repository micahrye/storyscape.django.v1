...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PageMediaObject.z_index'
        db.alter_column('storyscape_pagemediaobject', 'z_index', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PageMediaObject.ycoor'
        db.alter_column('storyscape_pagemediaobject', 'ycoor', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PageMediaObject.anime_code'
        db.alter_column('storyscape_pagemediaobject', 'anime_code', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PageMediaObject.height'
        db.alter_column('storyscape_pagemediaobject', 'height', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PageMediaObject.width'
        db.alter_column('storyscape_pagemediaobject', 'width', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'PageMediaObject.xcoor'
        db.alter_column('storyscape_pagemediaobject', 'xcoor', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'PageMediaObject.z_index'
        db.alter_column('storyscape_pagemediaobject', 'z_index', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PageMediaObject.ycoor'
        db.alter_column('storyscape_pagemediaobject', 'ycoor', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PageMediaObject.anime_code'
        db.alter_column('storyscape_pagemediaobject', 'anime_code', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PageMediaObject.height'
        db.alter_column('storyscape_pagemediaobject', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PageMediaObject.width'
        db.alter_column('storyscape_pagemediaobject', 'width', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'PageMediaObject.xcoor'
        db.alter_column('storyscape_pagemediaobject', 'xcoor', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'storyscape.pagemediaobject': {
            ...
            'animate_on': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'anime_code': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            ...
            'goto_page': ('django.db.models.fields.IntegerField', [], {'default': '-1'}),
            ...
            'trigger_reaction_on': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'width': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'xcoor': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'ycoor': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'z_index': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'storyscape.story': {
