...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.download_url'
        db.add_column('storyscape_story', 'download_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Story.thumb_url'
        db.add_column('storyscape_story', 'thumb_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.download_url'
        db.delete_column('storyscape_story', 'download_url')

        # Deleting field 'Story.thumb_url'
        db.delete_column('storyscape_story', 'thumb_url')
