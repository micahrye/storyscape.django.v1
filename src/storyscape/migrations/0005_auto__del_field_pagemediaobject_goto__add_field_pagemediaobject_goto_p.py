...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageMediaObject.goto'
        db.delete_column('storyscape_pagemediaobject', 'goto')

        # Adding field 'PageMediaObject.goto_page'
        db.add_column('storyscape_pagemediaobject', 'goto_page',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageMediaObject.goto'
        db.add_column('storyscape_pagemediaobject', 'goto',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, blank=True),
                      keep_default=False)

        # Deleting field 'PageMediaObject.goto_page'
        db.delete_column('storyscape_pagemediaobject', 'goto_page')
