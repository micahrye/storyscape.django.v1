...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageMediaObject.custom_cmds'
        db.delete_column('storyscape_pagemediaobject', 'custom_cmds')
    ...
    def backwards(self, orm):
        # Adding field 'PageMediaObject.custom_cmds'
        db.add_column('storyscape_pagemediaobject', 'custom_cmds',
                      self.gf('django.db.models.fields.CharField')(max_length=16384, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'storyscape.pagemediaobject': {
            ...
            'custom_comands': ('django.db.models.fields.CharField', [], {'max_length': '16384', 'null': 'True', 'blank': 'True'}),
