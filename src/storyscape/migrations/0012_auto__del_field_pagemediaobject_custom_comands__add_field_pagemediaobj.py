...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageMediaObject.custom_comands'
        db.delete_column('storyscape_pagemediaobject', 'custom_comands')

        # Adding field 'PageMediaObject.custom_commands'
        db.add_column('storyscape_pagemediaobject', 'custom_commands',
                      self.gf('django.db.models.fields.CharField')(max_length=16384, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageMediaObject.custom_comands'
        db.add_column('storyscape_pagemediaobject', 'custom_comands',
                      self.gf('django.db.models.fields.CharField')(max_length=16384, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'PageMediaObject.custom_commands'
        db.delete_column('storyscape_pagemediaobject', 'custom_commands')
    ...
    models = {
        ...
        'storyscape.pagemediaobject': {
            ...
            'custom_commands': ('django.db.models.fields.CharField', [], {'max_length': '16384', 'null': 'True', 'blank': 'True'}),
