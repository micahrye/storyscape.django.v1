...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Story.story_type'
        db.add_column('storyscape_story', 'story_type',
                      self.gf('django.db.models.fields.CharField')(default='standard', max_length=28),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Story.story_type'
        db.delete_column('storyscape_story', 'story_type')
    ...
    models = {
        ...
        'storyscape.story': {
            ...
            'story_type': ('django.db.models.fields.CharField', [], {'default': "'standard'", 'max_length': '28'}),
